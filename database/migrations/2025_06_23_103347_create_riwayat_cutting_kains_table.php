...
return new class extends Migration
{
    ...
    {
        Schema::create('riwayat_cutting_kain', function (Blueprint $table) {
            $table->id();

            $table->unsignedBigInteger('cutting_kain_id');
            ...
            $table->foreign('cutting_kain_id')->references('id')->on('cutting_kain')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('riwayat_cutting_kain');
    }
};
