...
class CuttingKain extends Model implements HasMedia
{
    use HasFactory, SoftDeletes, InteractsWithMedia;

    protected $table = 'cutting_kain';
    ...
    public function riwayatCuttingKain()
    {
        return $this->hasMany(RiwayatCuttingKain::class, 'cutting_kain_id');
    }
