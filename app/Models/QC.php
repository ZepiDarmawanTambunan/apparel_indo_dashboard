...
class QC extends Model implements HasMedia
{
    ...
    protected $appends = ['file_qc'];

    public function registerMediaCollections(): void
    {
        $this->addMediaCollection('file_qc')
            ->singleFile()
            ->acceptsMimeTypes(['image/jpeg', 'image/png', 'image/webp'])
            ->useDisk('public');
    }

    public function getFileQcAttribute()
    {
        return $this->getFirstMediaUrl('file_qc');
    }
