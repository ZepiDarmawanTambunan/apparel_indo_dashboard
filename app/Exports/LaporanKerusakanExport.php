    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('A1', 'Laporan Kerusakan (Status: Selesai)');
                ...
                $headers = [
                    ...
                    'Divisi Pelapor', 'Jumlah Rusak', 'Status', 'Status Checking', 'Keterangan'
                ];
                $col = 'A';
                ...
                if ($laporanKerusakan->isEmpty()) {
                    ...
                    $sheet->setCellValue('A5', 'Tidak ada data untuk ditampilkan');
                ...
                foreach ($laporanKerusakan as $index => $item) {
                    ...
                    $sheet->setCellValue("F{$row}", $item->jumlah_rusak ?? 0);
                    $sheet->setCellValue("H{$row}", $item->status->nama ?? '-');
